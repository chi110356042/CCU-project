				...
				if(strlen($row["price"])>10){
					echo "<div class=\"reprice\">";
						...
						echo "<p class=\"price\">".$row["price"] .
							"&nbsp;<input type=\"image\" name=\"send\" class=\"like\"  img src=\"img/redheart.png\" style=\"width:15px; height:15px;\" onclick=\"bad()\">
							</p>";	
					echo "</div>";
				}
				else{
		...
		echo "<div class=\"reccom\">";
			...
			{	
				...
				echo "<div class=\"smallr\" >";
					echo "<img src=\"img/good.png\" style=\"width:90px; height:149.5px;\">";
					//echo "<img class=\"rimg\" />";
