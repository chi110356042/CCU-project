<?php
	...
	if ($_POST['submit']=="登入"){
		...
		email='".mysqli_real_escape_string($link,$_POST['loginemail'])."' AND password='".md5(md5($_POST['loginemail']).$_POST['loginpassword'])."' LIMIT 1";
		...
		if ($row) {
			...
			header("Location:mainpage.php");
			 ...
			 $error2 = "We could not find a user with that email and password. Please try again later.";
		}
