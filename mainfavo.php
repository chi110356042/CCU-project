...
<?php				
				...
				$num=0;
				//echo"<p class=\"coursenum\">" ."目前所選的課程有「" .$tatol ."」個" ."</p>";
			echo "</div>";
			
			echo "<div class=\"down\">";
			
				echo "<div class=\"coursecotain\">";
				
				
				foreach($_SESSION["shoplist"] as $v){
					
					echo "<div class=\"course\">";
					echo "<img src=\"img/" .$v["img"] ."\" style=\"width:230px; height:130px;\"/>";
					echo "<a href='delefavorite.php?vid={$v["vid"]}' class=\"cross\"><img src=\"img/cross.png\" class=\"crossimg\"></a>";
					echo "<p class=\"fword\">" .$v["vname"] ."</p><br />";
					echo "<p class=\"fword\" style=\"color: grey; font-size:12px;\">" .$v["author"] ."</p><br />";
					//echo "<img src=\"img/172626-24.png\" style=\"width:15px; height:15px;\"><p>" .$v["person"] ."</p><br />";	

					if(strlen($v["price"])>10){
					echo "<div class=\"reprice\">";
						echo "<p class=\"delete\">" ."--------------" ."</p>";
						echo "<p class=\"price\">" .$v["price"] ."</p>";	
					echo "</div>";
					}
					else{
						echo "<p class=\"fprice\">" .$v["price"] ."</p>";	
					}
				...
				$tatol = $num;
				echo "<p class=\"coursenum\">" ."目前所選的課程有「" .$num ."」個" ."<p>";
				?>
				</div>
