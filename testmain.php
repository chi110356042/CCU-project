...
<body>
  ...
  <div id="nav">
			...
			<a href="todo.php" class="todo">My ToDo</a>
		</div>
  <?php
    $query="SELECT * FROM user WHERE
  email='".mysqli_real_escape_string($con,$_POST['loginemail'])."' AND password='".md5(md5($_POST['loginemail']).$_POST['loginpassword'])."' LIMIT 1";
...
function showSlides(n) {
  ...
  <div id="main">
    ...
    <div class="content">
      <div class="smallbox">
        ...
        <a href="python.php"><b>Python</b></a>
      </div>
  ...
  <img src="img/redheart.png" id="trytodo" style="width:50px; height:40px; position:absolute; top:500px; right:40px;  ">
